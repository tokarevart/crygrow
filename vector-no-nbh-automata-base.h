...
public:
    ...
    void resize_cells(const veci& corner0, const veci& corner1) {
    ...
    void reserve_cells(const veci& corner0, const veci& corner1) {
        auto new_origin = corner0;
        auto far_corner = corner1;
    ...
    virtual ~vector_no_nbh_automata_base() {}
...
template <std::size_t Dim, typename Cell, cell_mut_group CellMutGr>
class cell_iterator<vector_no_nbh_automata_base<Dim, Cell, CellMutGr>>
    : cell_iterator_base<vector_no_nbh_automata_base<Dim, Cell, CellMutGr>> {
public:
